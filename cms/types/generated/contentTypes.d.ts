...
export interface ApiEcosystemEcosystem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    prevImg: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    prevText: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
